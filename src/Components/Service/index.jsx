  ...
  return (
    ...
    >
      ...
      <Flex flexDirection="column">
        <Flex justifyContent="center" paddingTop={{ base: '5px', lg: '0px' }}>
          <Text
        ...
        <Flex justifyContent="center" padding={props.pButton || '20px 0px'}>
          <Button className="btn" bg="black" color="white" w="150px" h="35px">
